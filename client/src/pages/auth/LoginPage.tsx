...
export default function LoginPage() {
  ...
  const { login, googleLogin, googleRegister, setWorkspace } = useAuth();
  ...
  useEffect(() => {
    const initGoogleGSI = () => {
      ...
      if (google && google.accounts && btnEl && !isGoogleSignup) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-[20px]" key="login-main">
      ...
      <div className="w-full flex justify-center">
        <div className="relative w-full max-w-[384px] h-[40px] group">
